...
type notifier interface {
	push(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd
	pushCritical(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd
}
...
func (n Notificator) Push(title string, text string, timeout int, soundPath string, clickURL string, iconPath string, urgency string) error {
	icon := n.defaultIcon
	...
	if urgency == UR_CRITICAL {
		return n.notifier.pushCritical(title, text, timeout, soundPath, clickURL, icon).Run()
	}

	return n.notifier.push(title, text, timeout, soundPath, clickURL, icon).Run()
...
func (o osxNotificator) push(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
...
func (o osxNotificator) pushCritical(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
...
func (l linuxNotificator) push(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
	return exec.Command("notify-send", "-i", iconPath, title, text)
}

// Causes the notification to stick around until clicked.
func (l linuxNotificator) pushCritical(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
	return exec.Command("notify-send", "-i", iconPath, title, text, "-u", "critical")
}

type windowsNotificator struct{}

func (w windowsNotificator) push(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
	return exec.Command("growlnotify", "/i:", iconPath, "/t:", title, text)
}

// Causes the notification to stick around until clicked.
func (w windowsNotificator) pushCritical(title string, text string, timeout int, soundPath string, clickURL string, iconPath string) *exec.Cmd {
